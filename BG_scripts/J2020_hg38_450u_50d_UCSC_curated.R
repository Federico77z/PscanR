...
J2020_PSBG <- ps_build_bg(prom_seq, J2020, BPPARAM = MulticoreParam(36)) #Build Pscan Background

ps_write_bg_to_file(J2020_PSBG, "J2020_hg38_450u_50d_UCSC.psbg.txt")
