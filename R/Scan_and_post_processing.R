...
#' of interest, without having to recalculate them. 
#' 
#' @param ID A character vector containing the sequence identifiers of the
#'    sequences to be scanned with the PWMs.
