...
J2022_PSBG <- ps_build_bg(prom_seq, J2022, BPPARAM = SnowParam(12)) #Build Pscan Background

ps_write_bg_to_file(J2022_PSBG, "J2022_mm10_450u_50d_UCSC_refGene.psbg.txt")
