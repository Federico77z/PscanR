...
J2020_PSBG <- PscanR::ps_build_bg(prom_seq, J2020, BPPARAM = MulticoreParam(18)) #Build Pscan Background

ps_write_bg_to_file(J2020_PSBG, "J2020_mm10_950u_50d_UCSC_refGene.psbg.txt")
