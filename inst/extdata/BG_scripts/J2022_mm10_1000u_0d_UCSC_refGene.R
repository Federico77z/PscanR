...
prom_rng <- promoters(txdb, upstream = 1000, downstream = 0, use.names = TRUE) 
prom_seq <- getSeq(x = BSgenome.Mmusculus.UCSC.mm10, prom_rng) #promoter sequences
export(prom_rng, con = "mm10_1000_0.gtf", format = "gtf")
...
J2022_PSBG <- ps_build_bg(prom_seq, J2022, BPPARAM = MulticoreParam(18)) #Build Pscan Background

ps_write_bg_to_file(J2022_PSBG, "J2022_mm10_1000u_0d_UCSC_refGene.psbg.txt")
