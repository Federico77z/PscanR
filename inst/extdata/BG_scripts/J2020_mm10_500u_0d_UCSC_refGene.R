...
J2020_PSBG <- PscanR::ps_build_bg(prom_seq, J2020, BPPARAM = MulticoreParam(6)) #Build Pscan Background

ps_write_bg_to_file(J2020_PSBG, "J2020_mm10_500u_0d_UCSC_refGene.psbg.txt")
