...
**PscanR** accepts a list of gene identifiers corresponding to co-regulated or
co-expressed genes as input. Below is an example dataset containing **human
NF-κB target genes**, curated from the literature. The number **50** indicates
that 50% genes in the list are known NF-κB targets.
