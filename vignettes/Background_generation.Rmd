...
convenient
to store an enlarged version of the background containing key metrics such as
the score, position and oligonucleotide seuqence for each hit within the
...
fullfilled using the `save()` function in R. This will generate an .RData file.
